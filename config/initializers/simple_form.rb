...
SimpleForm.setup do |config|
    config.wrappers(:default, class: 'input row',hint_class: :field, error_class: :errors) do |b|
      b.use :html5
      b.use :placeholder
    ...
    config.wrappers :custom, class: 'input row',
      hint_class: :field_with_hint, form_class: :custom,
      label_class: 'control-label', error_class: :errors do |b|
      b.use :html5
      b.use :placeholder
      b.optional :maxlength
      b.optional :pattern
      ...
      b.wrapper tag: :div, class: 'large-12 small-12 columns' do |c|
        c.wrapper tag: :div, class: 'row' do |d|
          d.wrapper tag: :div, class: 'large-3 small-3 columns' do |e|
            e.use :label, class: 'right inline'
          end
